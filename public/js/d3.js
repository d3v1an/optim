        ...
        complete: function(file) {
            ...
            if(_status==true) {
                $.d3POST('/cjpg',{original:_original_file, original_size:_original_size, uploaded:_uploaded},function(data){
                    ...
                    // $('.left-bar').width( data.compress_percent_fix + '%!important' );
                    // $('.right-bar').width( (100-data.compress_percent_fix) + '%!important' );

                    //$('div#left-bar').width( '10%!important' );
                    //$('div#right-bar').width( '90%!important' );
